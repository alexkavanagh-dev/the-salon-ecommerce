"""
Django settings for the_salon project.
...
SECRET_KEY = 'django-insecure-(1b$2u6wfd_jug9g653w53*6n!*hi&0ay^y*k=t2y0wvp-!q!r'
...
WSGI_APPLICATION = 'the_salon.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'thesalon@example.com'
